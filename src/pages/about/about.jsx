        ...
        <div className="container">
          ...
          <div className="row g-5 containerAbout">
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              ...
              <p className="mb-3"><i className="far fa-check-circle text-primary me-3"></i>{t("Afordable Prices")}</p>
              <p className="mb-3"><i className="far fa-check-circle text-primary me-3"></i>{t("High Quality Product")}</p>
              <p className="mb-3"><i className="far fa-check-circle text-primary me-3"></i>{t("On Time Project Delivery")}</p>
              <a className="btn btn-primary py-3 px-5 mt-3" href="#home">{t("Read More")}</a>
            </div>
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
              <div className="row g-3 mb-4">
                <div className="col-sm-6">
                  <img className="img-fluid rounded" src={aboutImg1} alt="aboutImg1" />
                </div>
                <div className="col-sm-6">
                  <img className="img-fluid rounded" src={aboutImg2} alt="aboutImg2" />
                </div>
              </div>
