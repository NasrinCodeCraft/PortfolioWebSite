            ...
            <div className="row g-5">
                <div className="col-lg-5 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div className="d-flex pt-2">
                        <a className="btn btn-square btn-primary me-2" href=""><Telegram color="#ffff" size={20} /></a>
                        <a className="btn btn-square btn-primary me-2" href=""><Instagram color='#ffff' size={20} /></a>
                        <a className="btn btn-square btn-primary me-2" href=""><Youtube color="#ffff" size={20} /></a>
                        <a className="btn btn-square btn-primary me-2" href=""><Linkedin color="#ffff" size={20} /></a>
                    </div>
                </div>
